...
class DiffusionDistillation:
    ...
    def train_student(self, distill_train_loader, teacher_diffusion, student_diffusion, student_lr, device,num_epochs=10):
        ...
        for epoch in range(num_epochs):
            ...
            for data in pbar:
                ...
                loss = teacher_diffusion.distill_loss(student_diffusion, gt_image, cond_image, time)
                L = loss.item()
                L_tot += L
                N += 1
