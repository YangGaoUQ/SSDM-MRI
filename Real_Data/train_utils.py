...
class DiffusionDistillation:
    ...
    def train_student(self, distill_train_loader, teacher_diffusion, student_diffusion, student_lr, device,
                      num_epochs=-1):
        ...
        for epoch in range(num_epochs):
            ...
            student_model = Network(student_diffusion.net_, student_schedule, time_scale=student_diffusion.time_scale,
                                    distill=True)
